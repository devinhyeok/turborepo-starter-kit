...
export const Section = (props: Props) => {
  const { className, titleProps, title, description, children, tallPaddingY = false } = props
  return (
    <section className={cn('flex flex-col items-center justify-center px-6', className)}>
