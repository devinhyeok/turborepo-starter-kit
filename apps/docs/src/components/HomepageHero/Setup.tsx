    ...
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <h1 className={styles.headline}>
          ...
          Nextra <br className="sm:hidden"></br> Starter
          <br className="sm:hidden"></br> Template
        </h1>
        ...
        <div className={clsx([styles.subtitle, 'text-neutral-500 dark:text-neutral-300'])}>
          ...
          />
          <br />
          With <LinkPreview url="https://nextjs.org">Next.js</LinkPreview>,{' '}
          <LinkPreview url="https://tailwindcss.com">Tailwind CSS</LinkPreview>, and{' '}
          <LinkPreview url="https://ui.shadcn.com">Shadcn UI</LinkPreview>
          {', '}
          <LinkPreview url="https://ui.aceternity.com">Aceternity UI</LinkPreview>
        </div>
        <div className="flex justify-center pt-10">
          <div className="max-w-[500px] flex flex-wrap gap-[20px] max-sm:justify-center">
            ...
            >
              <Link href="https://github.com/pdsuwwz/nextjs-nextra-starter" target="_blank">
                Github
